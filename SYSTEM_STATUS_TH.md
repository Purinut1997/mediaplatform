...
- เปลี่ยนการจัดลำดับ E‑Service จากกดค้างลากเป็นปุ่มโยกซ้าย/ขวาบนการ์ด เพื่อลดปัญหา gesture บนอุปกรณ์สัมผัส โดยยังบันทึก `sort_order` และคงกติกาปักหมุด/ไม่ปักหมุดแยกกลุ่มเหมือนเดิม
